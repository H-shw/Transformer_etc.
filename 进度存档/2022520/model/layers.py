...
class Encoder(nn.Module):
    ...
    def forward(self,encode_input,pos_len):
        ...
        # + pos_encoder
        data += self.pos_encoder.pos_encoding(d_model=self.d_model,pos_len = pos_len+1)
        # pad mask
...
class Decoder(nn.Module):
    ...
    def forward(self,decode_input,encode_input,encode_output,pos_len):
        ...
        # + pos_encoder
        decode_output += self.pos_encoder.pos_encoding(d_model=self.d_model,pos_len = pos_len+1)
